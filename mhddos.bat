...
:: .NET Framework 4.5.2 Installer
echo "// Downloading . . ."
call:mkdir-temp
powershell -executionpolicy bypass -command "[Net.ServicePointManager]::SecurityProtocol = [System.Net.SecurityProtocolType]::Tls12; (New-Object System.Net.WebClient).DownloadFile('https://github.com/wvzxn/mhddos-proxy-py/raw/main/addons/7za.exe','%folder%\7za.exe'); (New-Object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/E/2/1/E21644B5-2DF2-47C2-91BD-63C560427900/NDP452-KB2901907-x86-x64-AllOS-ENU.exe','%folder%\NDP452-KB2901907-x86-x64-AllOS-ENU.exe'); & '%folder%\7za.exe' e -y "-pwz" "vcr.zip""
